...
func TestCreateLinReg(t *testing.T){
    ...
    testUtil.BasicTest(5,l.a.Rows(),"A matrix has wrong number of rows.",t);
    testUtil.BasicTest(5,l.a.Cols(),"A matrix has wrong number of cols.",t);
    testUtil.BasicTest(5,l.b.Rows(),"B matrix has wrong number of rows.",t);
    testUtil.BasicTest(1,l.b.Cols(),"B matrix has wrong number of cols.",t);
    testUtil.BasicTest(5,len(l.summationOps),
        "SummationOps matrix has wrong number of rows.",t,
    );
    testUtil.BasicTest(6,len(l.summationOps[0]),
        "SummationOps matrix has wrong number of cols.",t,
    );
    testUtil.BasicTest(5,len(l.iVarOps),"iVarOps has wrong number of elements.",t);
    l=NewLinearReg[float32](ConstSumOpGen[float32](5.0)([]string{"x1"},"y"));
    testUtil.BasicTest(1,l.a.Rows(),"A matrix has wrong number of rows.",t);
    testUtil.BasicTest(1,l.a.Cols(),"A matrix has wrong number of cols.",t);
    testUtil.BasicTest(1,l.b.Rows(),"B matrix has wrong number of rows.",t);
    testUtil.BasicTest(1,l.b.Cols(),"B matrix has wrong number of cols.",t);
    testUtil.BasicTest(1,len(l.summationOps),
        "SummationOps matrix has wrong number of rows.",t,
    );
    testUtil.BasicTest(2,len(l.summationOps[0]),
        "SummationOps matrix has wrong number of cols.",t,
    );
    testUtil.BasicTest(1,len(l.iVarOps),"iVarOps has wrong number of elements.",t);
}
...
func TestConstantLinearReg(t *testing.T){
    ...
    for i:=0; i<5; i++ {
        l.IterRHS(func(r int, c int, v float32){
            testUtil.BasicTest(float32(25*i),v,
        ...
        testUtil.BasicTest(nil,l.UpdateSummations(map[string]float32{}),
            "Summation returned error when it was not supposed to.",t,
        );
    }
    _,_,err:=l.Run();
    if !util.IsSingularMatrix(err) {
        testUtil.FormatError(util.SingularMatrix(""),err,
...
func Test1DStdLinearReg(t *testing.T){
    ...
    testUtil.BasicTest(float32(385),l.a.V[0][0],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float32(385),l.b.V[0][0],
        "B Summation was not run properly.",t,
    );
    res,rcond,err:=l.Run();
    testUtil.BasicTest(float64(1),rcond,
    ...
    for i:=-12; i<14; i+=2 {
        ...
        testUtil.BasicTest(float32(i),v,
            "Appropriate linear relationship was not found.",t,
        );
    }
}
...
func Test2DLinearReg(t *testing.T){
    ...
    testUtil.BasicTest(float64(385),l.a.V[0][0],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(85),l.a.V[1][1],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(180),l.a.V[1][0],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(180),l.a.V[0][1],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(385),l.b.V[0][0],
        "B Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(180),l.b.V[1][0],
        "B Summation was not run properly.",t,
    );
    res,_,err:=l.Run();
    testUtil.BasicTest(nil,err,
    ...
    for i:=-12; i<14; i+=2 {
        ...
        if Abs(float64(i)-v)>WORKING_PRECISION {
            testUtil.FormatError(float64(i),v,
...
func TestNonStdLinearReg(t *testing.T){
    ...
    testUtil.BasicTest(float64(5762),l.a.V[0][0],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(2766),l.a.V[0][1],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(2766),l.a.V[1][0],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(1333),l.a.V[1][1],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(1430),l.b.V[0][0],
        "A Summation was not run properly.",t,
    );
    testUtil.BasicTest(float64(680),l.b.V[1][0],
        "A Summation was not run properly.",t,
    );
    res,_,err:=l.Run();
    testUtil.BasicTest(nil,err,
